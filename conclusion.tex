...
Errors are concentrated in transition zones near the generator engagement speed (Zone~6)
and are a consequence of discretization rather than problems with the zone definitions.
Both classifiers generalise well across years.
