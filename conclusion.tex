...
variables. Eight of the nine zones are present in the dataset. The ninth zone (high-wind
...
\subsection*{RQ1: How accurately and interpretably do physics-informed rule-based classifiers
...
\subsection*{RQ2: How much accuracy improvement do supervised machine learning classifiers
...
\subsection*{RQ3: How effectively do deep reinforcement learning agents (DQN, PPO, A2C) learn
...
\subsection*{RQ4: What is the contribution of RIPPER-derived probability features to
...
\subsection*{RQ5: To what extent do physics-based guardrails improve DRL agent accuracy
and physical compliance, and how does this vary across different DRL algorithms?}
...
weights, which provides a conservative estimate of each algorithm's peak performance but
